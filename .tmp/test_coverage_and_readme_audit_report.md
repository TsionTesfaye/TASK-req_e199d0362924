...
| POST /api/admin/users | yes | true no-mock HTTP | tests/api.test.js | backend/src/main/java/com/rescuehub/controller/AdminController.java:30; tests/api.test.js:102 (test: admin can log in after bootstrap and response includes user+csrf) |
